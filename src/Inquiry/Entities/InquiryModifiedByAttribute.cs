...
/// upsert methods (including their batch forms) assign <see cref="InquiryAuditContext.CurrentUser"/>
...
/// </summary>
/// <remarks>
/// Set the ambient user with <see cref="InquiryAuditContext.BeginScope"/> (typically once per
