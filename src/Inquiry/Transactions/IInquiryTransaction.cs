...
public interface IInquiryTransaction : IAsyncDisposable
{
    ...
    IAsyncEnumerable<TEntity> QueryAsync<TEntity>(
        ...
        where TEntity : class
        => Inquiry.QueryAsync<TEntity>(commandText, cancellationToken);
    ...
    IAsyncEnumerable<TEntity> QueryAsync<TEntity>(
        ...
        CancellationToken cancellationToken = default)
        where TEntity : class
        => Inquiry.QueryAsync<TEntity>(commandText, parameters, cancellationToken);
    ...
    IAsyncEnumerable<TEntity> QueryAsync<TEntity>(
        ...
        CancellationToken cancellationToken = default)
        where TEntity : class
        => Inquiry.QueryAsync<TEntity>(command, cancellationToken);
    ...
    Task<IReadOnlyList<TEntity>> QueryListAsync<TEntity>(
        ...
        CancellationToken cancellationToken = default)
        where TEntity : class
        => Inquiry.QueryListAsync<TEntity>(commandText, cancellationToken);
    ...
    Task<IReadOnlyList<TEntity>> QueryListAsync<TEntity>(
        ...
        CancellationToken cancellationToken = default)
        where TEntity : class
        => Inquiry.QueryListAsync<TEntity>(commandText, parameters, cancellationToken);
    ...
    Task<IReadOnlyList<TEntity>> QueryListAsync<TEntity>(
        ...
        CancellationToken cancellationToken = default)
        where TEntity : class
        => Inquiry.QueryListAsync<TEntity>(command, cancellationToken);
    ...
    Task<TEntity?> QuerySingleOrDefaultAsync<TEntity>(
        ...
        CancellationToken cancellationToken = default)
        where TEntity : class
        => Inquiry.QuerySingleOrDefaultAsync<TEntity>(commandText, cancellationToken);
    ...
    Task<TEntity?> QuerySingleOrDefaultAsync<TEntity>(
        ...
        CancellationToken cancellationToken = default)
        where TEntity : class
        => Inquiry.QuerySingleOrDefaultAsync<TEntity>(commandText, parameters, cancellationToken);
    ...
    Task<TEntity?> QuerySingleOrDefaultAsync<TEntity>(
        ...
        CancellationToken cancellationToken = default)
        where TEntity : class
        => Inquiry.QuerySingleOrDefaultAsync<TEntity>(command, cancellationToken);

    /// <summary>Executes a SQL command and returns the affected row count, within this transaction.</summary>
    Task<int> ExecuteAsync(
        string commandText,
        CancellationToken cancellationToken = default)
        => Inquiry.ExecuteAsync(commandText, cancellationToken);
    ...
    Task<int> ExecuteAsync(
        ...
        object? parameters,
        CancellationToken cancellationToken = default)
        => Inquiry.ExecuteAsync(commandText, parameters, cancellationToken);

    /// <summary>Executes a SQL command and returns the affected row count, within this transaction.</summary>
    Task<int> ExecuteAsync(
        InquiryCommand command,
        CancellationToken cancellationToken = default)
        => Inquiry.ExecuteAsync(command, cancellationToken);

    /// <summary>Executes a command returning a single scalar value (COUNT/SUM/MIN/MAX/AVG), within this transaction.</summary>
    Task<T> ExecuteScalarAsync<T>(
        InquiryCommand command,
        CancellationToken cancellationToken = default)
        => Inquiry.ExecuteScalarAsync<T>(command, cancellationToken);
    ...
    Task<IInquiryTransaction> BeginTransactionAsync(CancellationToken cancellationToken = default)
        => Inquiry.BeginTransactionAsync(IsolationLevel, cancellationToken);
}
