...
public sealed class InquiryGenerator : ISourceGenerator
{
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        {
            GenerateServiceCollectionExtensions(context, entityRegistrations.ToImmutable(), storeRegistrations.ToImmutable());
        }
    }
    ...
    private static void GenerateServiceCollectionExtensions(
        ...
        ImmutableArray<StoreRegistrationModel> storeRegistrations)
    {
        ...
        source.AppendLine("{");
        source.AppendLine("    public static class InquiryServiceCollectionGeneratedExtensions");
        source.AppendLine("    {");
        source.AppendLine("        public static global::Microsoft.Extensions.DependencyInjection.IServiceCollection AddInquiryStores(this global::Microsoft.Extensions.DependencyInjection.IServiceCollection services)");
        source.AppendLine("        {");
        ...
        context.AddSource("InquiryServiceCollectionExtensions.g.cs", SourceText.From(source.ToString(), Encoding.UTF8));
    }
