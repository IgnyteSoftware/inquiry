...
/// class. No <c>InquirySqlDialect</c> call happens at runtime — stores depend only on
/// <see cref="Inquiry.IInquiry"/> and reuse the same const string for every invocation.
/// </remarks>
internal static class StoreProcessor
{
        ...
        SqlBuilder sqlBuilder)
    {
        ...
        // ---- Constructor: just forwards to the base. No SQL building remains at runtime. ----
        source.AppendLine();
