...
Inquiry follows [Semantic Versioning 2.0.0](https://semver.org/). Only the latest patch of each supported major.minor line receives bug fixes and security patches.

| Version | Status    | .NET TFMs              |
|---------|-----------|------------------------|
| 1.0.x   | Current   | net8.0, net9.0, net10.0 |
