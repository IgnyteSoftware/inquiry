...
public sealed class ColumnEncryptionIntegrationTests
{
    ...
    public ColumnEncryptionIntegrationTests(MySqlContainerFixture fixture)
    {
        _fixture = fixture;
    ...
    public async Task SecretRoundTripsButIsCiphertextAtRest()
    {
        ...
        await using var harness = await MySqlTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "encrypt");
