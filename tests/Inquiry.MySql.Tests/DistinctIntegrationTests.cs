...
public sealed class DistinctIntegrationTests
{
    ...
    public DistinctIntegrationTests(MySqlContainerFixture fixture) => _fixture = fixture;
    ...
    public async Task DistinctSelectAllDeduplicatesRows()
    {
        ...
        await using var harness = await MySqlTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "distinct");
