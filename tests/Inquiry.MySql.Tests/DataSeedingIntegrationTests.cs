...
public sealed class DataSeedingIntegrationTests
{
    ...
    public DataSeedingIntegrationTests(MySqlContainerFixture fixture) => _fixture = fixture;
    ...
    public async Task SeederPopulatesOnceAndIsIdempotentWithGuard()
    {
        ...
        await using var harness = await MySqlTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, ddl, "seed");
