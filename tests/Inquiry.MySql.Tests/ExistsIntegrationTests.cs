...
public sealed class ExistsIntegrationTests
{
    ...
    public ExistsIntegrationTests(MySqlContainerFixture fixture) => _fixture = fixture;
    ...
    public async Task AnyReflectsWhetherTableHasRows()
    {
        ...
        var harness = await MySqlTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "exists");
