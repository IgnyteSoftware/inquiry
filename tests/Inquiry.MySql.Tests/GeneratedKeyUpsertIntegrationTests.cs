...
public sealed class GeneratedKeyUpsertIntegrationTests
{
    ...
    public GeneratedKeyUpsertIntegrationTests(MySqlContainerFixture fixture) => _fixture = fixture;

    [SkippableFact]
    public async Task UpsertReturningUsesGeneratedKeyWhenKeyIsNull()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MySqlTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "gkupsert");
