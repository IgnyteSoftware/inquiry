...
public sealed class NegatedOperatorIntegrationTests
{
    ...
    public NegatedOperatorIntegrationTests(MySqlContainerFixture fixture) => _fixture = fixture;
    ...
    public async Task NotLikeExcludesPatternMatches()
    {
        ...
        await using var harness = await MySqlTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "negated");
