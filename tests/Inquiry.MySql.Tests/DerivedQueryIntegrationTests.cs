...
/// <summary>
/// Derived query methods end-to-end against MySQL: a field-less <c>[InquirySelectAllByField]</c>
...
public sealed class DerivedQueryIntegrationTests
{
    ...
    public DerivedQueryIntegrationTests(MySqlContainerFixture fixture) => _fixture = fixture;
    ...
    public async Task DerivedSingleAndMultiFieldFiltersWork()
    {
        ...
        await using var harness = await MySqlTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "derived");
