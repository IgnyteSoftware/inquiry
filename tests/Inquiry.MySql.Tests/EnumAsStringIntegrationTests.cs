...
public sealed class EnumAsStringIntegrationTests
{
    ...
    public EnumAsStringIntegrationTests(MySqlContainerFixture fixture) => _fixture = fixture;
    ...
    public async Task StoresAndReadsEnumMemberNames()
    {
        ...
        await using var harness = await MySqlTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "enumstr");
