...
public sealed class EagerMixedRelationIntegrationTests
{
    ...
    public EagerMixedRelationIntegrationTests(MySqlContainerFixture fixture) => _fixture = fixture;
    ...
    private async Task<(MySqlTestHarness Harness, BatchExecutionProbe Probe, RecordingCommandInterceptor Recorder)> CreateHarnessAsync()
    {
