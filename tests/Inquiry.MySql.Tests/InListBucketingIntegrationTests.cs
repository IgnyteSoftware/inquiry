...
/// <summary>
/// Live coverage of IN-list bucketing and its NOT IN counterpart against real MySQL: the expansion pads
...
public sealed class InListBucketingIntegrationTests
{
    ...
    public InListBucketingIntegrationTests(MySqlContainerFixture fixture) => _fixture = fixture;
    ...
    {
        var harness = await MySqlTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, ProductsDdl, "inbucket");
