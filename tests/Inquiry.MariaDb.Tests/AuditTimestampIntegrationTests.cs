...
/// <summary>
/// Auditing timestamps end-to-end against real MariaDB: insert stamps both columns (caller-observable),
...
public sealed class AuditTimestampIntegrationTests
{
    ...
    public AuditTimestampIntegrationTests(MariaDbContainerFixture fixture) => _fixture = fixture;

    [SkippableFact]
    public async Task InsertStampsBothTimestamps()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, FeatureSchema.AuditTimestampMySqlDdl, "audit");
