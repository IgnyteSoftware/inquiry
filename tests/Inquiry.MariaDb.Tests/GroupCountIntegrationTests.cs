...
public sealed class GroupCountIntegrationTests
{
    ...
    public GroupCountIntegrationTests(MariaDbContainerFixture fixture) => _fixture = fixture;
    ...
    public async Task CountByCategoryReturnsGroupedCounts()
    {
        ...
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "groupcount");
