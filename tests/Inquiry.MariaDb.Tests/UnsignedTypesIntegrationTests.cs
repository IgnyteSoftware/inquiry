...
public sealed class UnsignedTypesIntegrationTests
{
    ...
    public UnsignedTypesIntegrationTests(MariaDbContainerFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task Byte_RoundTrips()
    {
        ...
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdByte");
    ...
    public async Task Int16_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdI16");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task Int32_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdI32");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task Int64_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdI64");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task EnumInt32_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdEI32");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task SByte_Low_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdSB2");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task SByte_NegativeOne_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdSB3");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task SByte_MinValue_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdSB4");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt16_Low_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdU162");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt16_AboveShortMax_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdU163");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt16_MaxValue_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdU164");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt32_Low_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdU322");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt32_AboveIntMax_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdU323");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt32_MaxValue_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdU324");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt64_Low_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdU642");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt64_AboveLongMax_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdU643");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task EnumSByte_Negative_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdESBn");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task EnumUInt16_AboveShortMax_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdEU16a");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task EnumUInt32_AboveIntMax_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdEU32a");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task EnumUInt64_AboveLongMax_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesMySqlDdl, "UnsignedMdEU64a");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
