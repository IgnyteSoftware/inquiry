...
/// MariaDB. Three things only a live engine settles: that a cross-tenant key write affects nothing
...
public sealed class WriteEnforcedFilterIntegrationTests
{
    ...
    public WriteEnforcedFilterIntegrationTests(MariaDbContainerFixture fixture) => _fixture = fixture;
    ...
    private Task<MariaDbTestHarness> CreateHarnessAsync()
        => MariaDbTestHarness.CreateFromDdlAsync(
