...
/// <summary>
/// <c>[InquiryCreatedBy]</c>/<c>[InquiryModifiedBy]</c> end-to-end against real MariaDB: insert stamps
...
public sealed class AuditUserIntegrationTests
{
    ...
    public AuditUserIntegrationTests(MariaDbContainerFixture fixture) => _fixture = fixture;

    [SkippableFact]
    public async Task InsertStampsBothFromAmbientUser()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await MariaDbTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, FeatureSchema.AuditUserMySqlDdl, "audituser");
