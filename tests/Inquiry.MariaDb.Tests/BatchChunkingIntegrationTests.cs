...
public sealed class BatchChunkingIntegrationTests
{
    ...
    public BatchChunkingIntegrationTests(MariaDbContainerFixture fixture) => _fixture = fixture;
    ...
    private Task<MariaDbTestHarness> CreateAsync(BatchExecutionProbe probe)
