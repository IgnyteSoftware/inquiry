...
/// #49 (write: DbType.UInt32 / UInt16 / UInt64 / SByte set on SqlParameter).
///
...
/// These edge values are precisely what failed before the fix, so they are the key proof on
/// SQL Server (the provider that rejected DbType.SByte/UInt16/UInt32/UInt64 at bind time).
/// </summary>
...
public sealed class UnsignedTypesIntegrationTests
{
    ...
    public UnsignedTypesIntegrationTests(SqlServerContainerFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task Byte_RoundTrips()
    {
        ...
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsByte");
    ...
    public async Task Int16_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsI16");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task Int32_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsI32");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task Int64_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsI64");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task EnumInt32_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsEI32");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    // sbyte -1 → byte 255 → fits TINYINT; reads back as -1.
    // ---------------------------------------------------------------------------
    ...
    public async Task SByte_Low_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsSB2");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task SByte_NegativeOne_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsSB3");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task SByte_MinValue_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsSB4");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    // ushort 40000 → short -25536 → fits SMALLINT; reads back as 40000.
    // ---------------------------------------------------------------------------
    ...
    public async Task UInt16_Low_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsU162");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt16_AboveShortMax_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsU163");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt16_MaxValue_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsU164");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    // uint 3_000_000_000 → int -1_294_967_296 → fits INT; reads back to 3_000_000_000.
    // ---------------------------------------------------------------------------
    ...
    public async Task UInt32_Low_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsU322");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt32_AboveIntMax_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsU323");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt32_MaxValue_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsU324");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    // ulong.MaxValue → long -1 → fits BIGINT; reads back to ulong.MaxValue.
    // ---------------------------------------------------------------------------
    ...
    public async Task UInt64_Low_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsU642");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task UInt64_AboveLongMax_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsU643");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task EnumSByte_Negative_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsESBn");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task EnumUInt16_AboveShortMax_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsEU16a");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task EnumUInt32_AboveIntMax_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsEU32a");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
    ...
    public async Task EnumUInt64_AboveLongMax_RoundTrips()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedTypesSqlServerDdl, "UnsignedSsEU64a");
        var store = harness.GetRequiredService<UnsignedTypesItemStore>();
