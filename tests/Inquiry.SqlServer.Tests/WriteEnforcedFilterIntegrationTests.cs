...
/// SQL Server. Three things only a live engine settles: that a cross-tenant key write affects nothing
...
public sealed class WriteEnforcedFilterIntegrationTests
{
    ...
    public WriteEnforcedFilterIntegrationTests(SqlServerContainerFixture fixture) => _fixture = fixture;
    ...
    private Task<SqlServerTestHarness> CreateHarnessAsync()
        => SqlServerTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.WriteEnforcedDocSqlServerDdl, "wenf");
