...
public sealed class ColumnEncryptionIntegrationTests
{
    ...
    private const string Ddl =
        "CREATE TABLE SecretRecord (Id NUMBER(10) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, Label VARCHAR2(255) NOT NULL, Secret VARCHAR2(4000) NOT NULL)";

    public ColumnEncryptionIntegrationTests(OracleContainerFixture fixture)
    {
        _fixture = fixture;
    ...
    public async Task SecretRoundTripsButIsCiphertextAtRest()
    {
        ...
        await using var harness = await OracleTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "encrypt");
