...
public sealed class DataSeedingIntegrationTests
{
    ...
    public DataSeedingIntegrationTests(OracleContainerFixture fixture) => _fixture = fixture;
    ...
    public async Task SeederPopulatesOnceAndIsIdempotentWithGuard()
    {
        ...
        const string ddl = "CREATE TABLE SeededItem (Id NUMBER(10) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, Name VARCHAR2(255) NOT NULL)";
        await using var harness = await OracleTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, ddl, "seed");
