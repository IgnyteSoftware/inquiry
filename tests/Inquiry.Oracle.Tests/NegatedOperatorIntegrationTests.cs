...
public sealed class NegatedOperatorIntegrationTests
{
    ...
    public NegatedOperatorIntegrationTests(OracleContainerFixture fixture) => _fixture = fixture;

    private const string Ddl = "CREATE TABLE NegatedProduct (Id NUMBER(10) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, Name VARCHAR2(255) NOT NULL, Qty NUMBER(10) NOT NULL)";

    [SkippableFact]
    public async Task NotLikeExcludesPatternMatches()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await OracleTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "negated");
