...
/// <summary>
/// Value converters against real Oracle via the shared <see cref="JsonDoc"/> catalog entity: a custom value
...
public sealed class ConverterIntegrationTests
{
    ...
    public ConverterIntegrationTests(OracleContainerFixture fixture) => _fixture = fixture;

    [SkippableFact]
    public async Task ConverterAndJsonColumnsRoundTrip()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await OracleTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, FeatureSchema.OracleDdl, "conv");
