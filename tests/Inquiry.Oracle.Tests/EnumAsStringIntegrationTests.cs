...
public sealed class EnumAsStringIntegrationTests
{
    ...
    public EnumAsStringIntegrationTests(OracleContainerFixture fixture) => _fixture = fixture;

    private const string Ddl = """CREATE TABLE Ticket (Id NUMBER(10) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, Status VARCHAR2(255) NOT NULL, "Prior" VARCHAR2(255) NULL)""";

    [SkippableFact]
    public async Task StoresAndReadsEnumMemberNames()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await OracleTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "enumstr");
