...
public sealed class GroupCountIntegrationTests
{
    ...
    public GroupCountIntegrationTests(OracleContainerFixture fixture) => _fixture = fixture;

    private const string Ddl = "CREATE TABLE GroupItem (Id NUMBER(10) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, Category VARCHAR2(255) NOT NULL, Priority NUMBER(10) NOT NULL)";

    [SkippableFact]
    public async Task CountByCategoryReturnsGroupedCounts()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await OracleTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "groupcount");
