...
/// <summary>
/// Derived query methods end-to-end against Oracle: a field-less <c>[InquirySelectAllByField]</c>
...
public sealed class DerivedQueryIntegrationTests
{
    ...
    public DerivedQueryIntegrationTests(OracleContainerFixture fixture) => _fixture = fixture;

    private const string Ddl = "CREATE TABLE Person (Id NUMBER(10) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, Country VARCHAR2(255) NOT NULL, City VARCHAR2(255) NOT NULL)";

    [SkippableFact]
    public async Task DerivedSingleAndMultiFieldFiltersWork()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await OracleTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "derived");
