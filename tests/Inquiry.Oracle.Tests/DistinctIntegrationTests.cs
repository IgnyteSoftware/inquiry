...
public sealed class DistinctIntegrationTests
{
    ...
    public DistinctIntegrationTests(OracleContainerFixture fixture) => _fixture = fixture;

    private const string Ddl = "CREATE TABLE DistinctProduct (Id NUMBER(10) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, Name VARCHAR2(255) NOT NULL, Category VARCHAR2(255) NOT NULL)";

    [SkippableFact]
    public async Task DistinctSelectAllDeduplicatesRows()
    {
        Skip.IfNot(_fixture.IsAvailable, _fixture.SkipReason);
        await using var harness = await OracleTestHarness.CreateFromDdlAsync(_fixture.AdminConnectionString, Ddl, "distinct");
