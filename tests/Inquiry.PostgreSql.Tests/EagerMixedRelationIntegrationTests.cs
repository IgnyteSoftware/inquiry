...
public sealed class EagerMixedRelationIntegrationTests
{
    ...
    public EagerMixedRelationIntegrationTests(PostgreSqlContainerFixture fixture) => _fixture = fixture;
    ...
    private async Task<(PostgreSqlTestHarness Harness, BatchExecutionProbe Probe, RecordingCommandInterceptor Recorder)> CreateHarnessAsync()
    {
        ...
        var harness = await PostgreSqlTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.EagerMixedPostgreSqlDdl, "eagermixed",
