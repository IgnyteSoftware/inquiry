...
public sealed class UnsignedKeyEagerIntegrationTests
{
    ...
    public UnsignedKeyEagerIntegrationTests(PostgreSqlContainerFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task EagerLoadByUnsignedKey_AboveIntMax_RoundTripsWithChildren()
    {
        ...
        await using var harness = await PostgreSqlTestHarness.CreateFromDdlAsync(
            _fixture.AdminConnectionString, FeatureSchema.UnsignedKeyEagerPostgreSqlDdl, "UnsignedKeyEager");
