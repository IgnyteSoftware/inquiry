...
{
	public class Products :Collection<Product>, IEnumerable<Product>, IComparer
	{
		...
		public void Sort(string sortingExpression)
		{
			...
			Product[] elements =new Product[this.Items.Count];
		...
		{
			return new Products.Enumerator(this);
		}
