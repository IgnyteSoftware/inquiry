...
{
	public class EmployeeTerritories :Collection<EmployeeTerritory>, IEnumerable<EmployeeTerritory>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private EmployeeTerritories t;

			public Enumerator (EmployeeTerritories t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			EmployeeTerritory[] elements =new EmployeeTerritory[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(EmployeeTerritory item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new EmployeeTerritories.Enumerator(this);
		}
