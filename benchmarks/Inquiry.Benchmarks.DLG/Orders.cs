...
{
	public class Orders :Collection<Order>, IEnumerable<Order>, IComparer
	{
		...
		public void Sort(string sortingExpression)
		{
			...
			Order[] elements =new Order[this.Items.Count];
		...
		{
			return new Orders.Enumerator(this);
		}
