...
{
	public class OrderDetails :Collection<OrderDetail>, IEnumerable<OrderDetail>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			public Enumerator (OrderDetails t)
			{
				this.t = t;
			}
		...
		{
			return new OrderDetails.Enumerator(this);
		}
