...
{
	public class Territories :Collection<Territory>, IEnumerable<Territory>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private Territories t;

			public Enumerator (Territories t)
			{
				this.t = t;
			}
		...
		{
			return new Territories.Enumerator(this);
		}
