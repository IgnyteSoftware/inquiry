...
{
	public class CustomerDemographics :Collection<CustomerDemographic>, IEnumerable<CustomerDemographic>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			private CustomerDemographics t;

			public Enumerator (CustomerDemographics t)
			{
				this.t = t;
			}
		...
		public void Sort(string sortingExpression)
		{
			...
			CustomerDemographic[] elements =new CustomerDemographic[this.Items.Count];
			this.Items.CopyTo(elements,0);
			Array.Sort(elements,this);
			//clear old order and copy new order here
			this.Items.Clear();
			foreach(CustomerDemographic item in elements)
				this.Items.Add(item);
		}
		...
		{
			return new CustomerDemographics.Enumerator(this);
		}
