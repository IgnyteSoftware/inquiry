...
{
	public class Categories :Collection<Category>, IEnumerable<Category>, IComparer
	{
		 ...
		 public class Enumerator : IEnumerator
		 {
			...
			public Enumerator (Categories t)
			{
				this.t = t;
			}
		...
		{
			return new Categories.Enumerator(this);
		}
